...
<div class="jumbotron">
  <h1 class="display-4">Administraci&oacute;n de Constancias !</h1>
  <p class="lead">En el cual podremos imprimir las Constancias para el año  {{  date('Y')}}   <i class="mdi mdi-file-check"></i></p>
  <hr class="my-4">    
</div>      
</div>
    <div class="card-body">
    <div class="row">    
            <div class="col-lg-5 offset-3">
                 ...
                 <img class="card-img-top img-circle" src="/images/print1.png" height="60"  alt="Imprimir" style="width:100px;align-self:center;margin:12px;">                        
                        <div class="card-body">
                        <p class="text-capitalize text-center">Constancia por Estudiantes</p>
                        ...
                        <div class="row">
                                <div class="col-lg-12">        
                                        <button type="button" class="btn btn-success btn-block btn-rounded" id="btn_generateConstancy" data-toggle="tooltip" data-placement="top" title="Genera el certificado PDF">Generar  <i class="mdi mdi-printer"></i></button>
                                </div>
                        </div>
                        </div>
                        </div>
...
@push('custom-scripts')    
    <script src="{{ asset('/lib/constancy.js') }}"></script>   
@endpush
@push('style')
<style type="text/css">
.card-border-outset{
