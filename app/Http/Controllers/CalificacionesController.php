...
class CalificacionesController extends Controller
{
    ...
    public function summaryRating($period){    
        ...
        $grades=DB::SELECT("SELECT tb3.id_asignatura,tb1.id_grado,tb1.nombre,tb1.grupo,tb3.created_at,tb4.nombre as asignatura,tb4.id_asignatura FROM grado as tb1
                            ...
                            where tb2.id_estado_matricula=1 AND tb3.id_docente='$id_user' AND tb3.id_periodo='$period'  GROUP BY tb3.id_asignatura ");
            $data=[]; $i=1;
